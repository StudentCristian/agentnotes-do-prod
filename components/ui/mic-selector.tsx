...
export function MicSelector({
  ...
  const selectedDevice = value ?? (internalSelectedDevice || defaultDeviceId)
    ...
    <DropdownMenu onOpenChange={handleDropdownOpenChange}>
      <DropdownMenuTrigger asChild>
        <Button
          ...
          size="default"
          className={cn(
            "h-9 w-40 min-w-0 shrink cursor-pointer items-center gap-1.5 rounded-md px-2.5 hover:bg-accent sm:w-48",
            className
          )}
          ...
          <>
            ...
            <div className="flex items-center gap-2 p-2">
              <Button
                ...
                className="h-9 rounded-md px-2.5 hover:bg-accent"
              >
                {isMuted ? (
